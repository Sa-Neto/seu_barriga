exports.seed = function(knex, Promise) {
  ...
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      { id: 10000, name: 'User #1', mail: 'user1@mail.com', passwd: '$2a$10$yazvL84b764nmk9/DE4yLeKGaQLOR3Qv4sKq9o9Q63g3MmE6Jl57K'},
      { id: 10001, name: 'User #2', mail: 'user2@mail.com', passwd: '$2a$10$yazvL84b764nmk9/DE4yLeKGaQLOR3Qv4sKq9o9Q63g3MmE6Jl57K'}
    ]))
